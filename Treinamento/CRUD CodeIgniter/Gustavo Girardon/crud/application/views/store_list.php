...
<div class="container">
	...
	<div class="row">
		<div class="col-sm-8 col-sm-offset-2">
			...
			<a href="<?php echo base_url(); ?>index.php/store/viewStoreList" class="btn btn-primary"><span class="glyphicon glyphicon-plus"></span> View Store List</a>
			<br><br>
				...
				<tbody>
					...
					foreach($store as $sto){
						...
						<tr>
							...
							<td><a href="<?php base_url(); ?>index.php/users/edit/<?php echo $sto->idStore; ?>" class="btn btn-success"><span class="glyphicon glyphicon-edit"></span> Edit</a> || <a href="<?php echo base_url(); ?>index.php/users/delete/<?php $sto->idStore; ?>" class="btn btn-danger"><span class="glyphicon glyphicon-trash"></span> Delete</a></td>
						</tr>
						<?php
					}
					?>
