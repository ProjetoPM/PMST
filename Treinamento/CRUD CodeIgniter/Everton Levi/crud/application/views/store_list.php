					...
					<tbody>
						...
						foreach($store as $sto){
							...
							<tr>
								...
								<td><a href="<?php echo base_url(); ?>index.php/users/edit/<?php echo $sto->idStore; ?>" class="btn btn-success"><span class="glyphicon glyphicon-edit">	</span> Edit</a>
								 || 
								 <a href="<?php echo base_url(); ?>index.php/users/delete/<?php echo $sto->idStore; ?>" class="btn btn-danger"><span class="glyphicon glyphicon-trash"></span> Delete</a></td>
							</tr>
							<?php
						}
						?>
