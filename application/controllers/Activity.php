...
class Activity extends CI_Controller
{
	...
	public function deleteActivity($project_id)
	{
		$project_id['project_id'] = $this->input->post('project_id');
		$query = $this->Activity_model->deleteActivity($project_id);
		if ($query) {
			$this->load->view('frame/header_view');
			$this->load->view('frame/sidebar_nav_view2', $project_id);
	...
	public function editActivity($project_id)
	{
		$query['activity'] = $this->Activity_model->getActivity($project_id);
	...
	public function updateActivity($project_id)
	{
		...
		$query = $this->Activity_model->updateActivity($data['activity'], $project_id);
	...
	public function insertActivity($project_id)
	{
		$activity['associated_id'] = $this->input->post('associated_id');
		$activity['project_phase'] = $this->input->post('project_phase');
		$activity['milestone'] = $this->input->post('milestone');
	...
	public function editScheduleNetwork($project_id)
	{
		$query['activity'] = $this->Activity_model->getActivity($project_id);
	...
	public function updateScheduleNetwork($project_id)
	{
	...
	public function editDurationEstimates($project_id)
	{
		$query['activity'] = $this->Activity_model->getActivity($project_id);
	...
	public function updateDurationEstimates($project_id)
	{
	...
	public function editResourceRequirement($project_id)
	{
		$query['activity'] = $this->Activity_model->getActivity($project_id);
	...
	public function updateResourceRequirement($project_id)
	{
	...
	public function editResourceCalendar($project_id)
	{
		$query['activity'] = $this->Activity_model->getActivity($project_id);
	...
	public function updateResourceCalendar($project_id)
	{
	...
	public function editCostEstimation($project_id)
	{
		$query['activity'] = $this->Activity_model->getActivity($project_id);
	...
	public function updateCostEstimation($project_id)
	{
	...
	public function editAgregateValue($project_id)
	{
		$query['activity'] = $this->Activity_model->getActivity($project_id);
	...
	public function updateAgregateValue($project_id)
	{
	...
	public function editQuantitative($project_id)
	{
		$query['activity'] = $this->Activity_model->getActivity($project_id);
	...
	public function updateQuantitative($project_id)
	{
