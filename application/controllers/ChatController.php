...
class ChatController extends CI_Controller {
	...
	public function index(){
		 ...
		 $data['strTitle']='All Knowledge Areas';
		 $data['strsubTitle']='Knowledge Areas';
		 $data['chatTitle']='Select Knowledge Area with Chat';
		...
		foreach($list as $u){
		   $vendorslist[]=
		   [
			   'id' => $this->OuthModel->Encryptor('encrypt', $u['view_id']),
			   'name' => $u['view_name'],
			   'picture_url' => base_url('assets\images\lesse_logo.png'),
