<div id="page-wrapper">
    ...
    <div class="row">
        <div class="col-lg-12">      
            ...
            <input id="project_id" name="project_id" type="hidden" placeholder="Title" class="form-control input-md" value="<?= $human_resource_mp[0]->project_id;?>" required="true" readonly>
              ...
              <input id="human_resource-submit" type="submit" value="Update" class="btn btn-lg btn-success btn-block">
