				...
				<div class="row">
					<div class="col-lg-12">
						<div class="panel-body">
							...
							<form method="POST" action="<?= base_url() ?>weekly-evaluation/update-score/<?= $weekly_report[0]->weekly_report_id ?>">
									...
									<div>
										<select id="score" name="score" class="form-control" required>
											<?php foreach($scores as $s): ?>
											    <option <?= $s->name === $score[0]->grade ? 'selected' : ''?> value="<?= $s->score_id ?>"><?= $s->name?></option>
											<?php endforeach; ?>
										</select>
									</div>
								</div>
								...
								<div class=" col-lg-6 form-group">
                                    ...
                                    <textarea oninput="limitText(this, 5e3, 'a')" maxlength="2000" class="form-control" name="comments" required><?= $score[0]->comments ?></textarea>
								</div>
