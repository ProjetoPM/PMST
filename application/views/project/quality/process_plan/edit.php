	...
	<div class="row">
		<div class="col-lg-12">
			...
			?>
					...
					<form onsubmit="Checkfiles(this)" method="POST" action="<?php echo base_url('Process_plan/update/'); ?>">
						...
						<div class=" col-lg-12 form-group">
							...
							<div>
								<textarea oninput="eylem(this, this.value)" class="form-control elasticteste" id="process_limits" name="process_limits"><?= $process->process_limits; ?></textarea>
							</div>
						</div>
						...
						<div class="col-lg-12 form-group">
							...
							<div>
								<textarea oninput="eylem(this, this.value)" class="form-control elasticteste" id="process_configuration" name="process_configuration"><?= $process->process_configuration; ?></textarea>
							</div>
						...
						<div class="col-lg-12 form-group">
							...
							<div>
								<textarea oninput="eylem(this, this.value)" class="form-control elasticteste" id="process_metrics" name="process_metrics"><?= $process->process_metrics; ?></textarea>
							</div>
						</div>
						...
						<div class=" col-lg-12 form-group">
							...
							<div>
								<textarea oninput="eylem(this, this.value)" class="form-control elasticteste" id="goals_performance_improvement" name="goals_performance_improvement"><?= $process->goals_performance_improvement; ?></textarea>
							</div>
						</div>
