					...
					if($tep->project_id==$id){
						...
						<form method="POST" action="<?php echo base_url('TEP/insert/'); ?><?php echo $id[0]; ?>">
							...
							<div class=" col-lg-6 form-group">
								...
								<div >                 
									<input oninput="eylem(this, this.value)" class="form-control" type="date" id="project_closure_date" name="project_closure_date" value="<?= $tep[0]->project_closure_date;?>">
								</div>
							</div>
<!--
							<div class=" col-lg-6 form-group">
								...
								<div >                 
									<textarea oninput="eylem(this, this.value)" class="form-control elasticteste" id="project_closure_date" name="project_closure_date" required="true"><?= $tep[0]->project_closure_date;?></textarea>  
								</div>
							</div>
						-->
						...
						<div class=" col-lg-6 form-group">
							...
							<div >                 
								<textarea oninput="eylem(this, this.value)" class="form-control elasticteste" id="main_changes_approved" name="main_changes_approved" required="true"><?= $tep[0]->main_changes_approved;?></textarea>  
							</div>
						</div>
						...
						<div class=" col-lg-6 form-group">
							...
							<div >                 
								<textarea oninput="eylem(this, this.value)" class="form-control elasticteste" id="main_lessons_learned" name="main_lessons_learned" required="true"><?= $tep[0]->main_lessons_learned;?></textarea>  
							</div>
						</div>
