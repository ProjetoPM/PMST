					...
					<div class="col-lg-12">
						<div class="panel-body">
							...
							<div class=" col-lg-6 form-group">
									...
									<div>
									<input id="eval_txt_1" type="text" name="team_member_name" class="form-control input-md" onkeyup = "limite_textarea(this.value, 'eval_1')" maxlength="2000" oninput="eylem(this, this.value)" required="true">
									</div>
								</div>
								...
								<div class=" col-lg-6 form-group">
									...
									<div>
									<input id="eval_txt_2" type="text" name="role" class="form-control input-md" onkeyup = "limite_textarea(this.value, 'eval_2')" maxlength="2000" oninput="eylem(this, this.value)" required="false" >
									</div>
								</div>
								...
								<div class=" col-lg-6 form-group">
									...
									<div>
									<input id="eval_txt_3" type="text" name="project_function" class="form-control input-md" onkeyup = "limite_textarea(this.value, 'eval_3')" maxlength="2000" oninput="eylem(this, this.value)" required="false">
									</div>
								</div>
								...
								<div class="col-lg-12 form-group">
									...
									<div>
									<textarea onkeyup="limite_textarea(this.value, 'eval_4')" id="eval_txt_4" maxlength="2000" oninput="eylem(this, this.value)" class="form-control elasticteste" name="team_member_comments"></textarea>
									</div>
								</div>
								...
								<div class="col-lg-12 form-group">
									...
									<div>
									<textarea onkeyup="limite_textarea(this.value, 'eval_5')" id="eval_txt_5" maxlength="2000" oninput="eylem(this, this.value)" class="form-control elasticteste" name="strong_points"></textarea>
									</div>
								</div>
								...
								<div class="col-lg-12 form-group">
									...
									<div>
									<textarea onkeyup="limite_textarea(this.value, 'eval_6')" id="eval_txt_6" maxlength="2000" oninput="eylem(this, this.value)" class="form-control elasticteste" name="improvement"></textarea>
									</div>
								</div>
								...
								<div class="col-lg-12 form-group">
									...
									<div>
									<textarea onkeyup="limite_textarea(this.value, 'eval_7')" id="eval_txt_7" maxlength="2000" oninput="eylem(this, this.value)" class="form-control elasticteste" name="development_plan"></textarea>
									</div>
								</div>
								...
								<div class="col-lg-12 form-group">
									...
									<div>
									<textarea onkeyup="limite_textarea(this.value, 'eval_8')" id="eval_txt_8" maxlength="2000" oninput="eylem(this, this.value)" class="form-control elasticteste" name="already_developed"></textarea>
									</div>
								</div>
								...
								<div class="col-lg-12 form-group">
									...
									<div>
									<textarea onkeyup="limite_textarea(this.value, 'eval_9')" id="eval_txt_9" maxlength="2000" oninput="eylem(this, this.value)" class="form-control elasticteste" name="external_comments"></textarea>
									</div>
								</div>
								...
								<div class="col-lg-12 form-group">
									...
									<div>
									<textarea onkeyup="limite_textarea(this.value, 'eval_10')" id="eval_txt_10" maxlength="2000" oninput="eylem(this, this.value)" class="form-control elasticteste" name="team_mates_comments"></textarea>
									</div>
								</div>
								...
								<div class="col-lg-12 form-group">
									...
									<div>
									<textarea onkeyup="limite_textarea(this.value, 'eval_11')" id="eval_txt_11" maxlength="2000" oninput="eylem(this, this.value)" class="form-control elasticteste" name="team_performance_evaluationcol"></textarea>
									</div>
								</div>
							...
							<form action="<?php echo base_url('resources/team-performance-assessments/list/'); ?><?php echo $id; ?>">
