<div id="page-wrapper">
	<div class="row">
		<div class="col-lg-12">
			<h1 class="page-header"> <?=$this->lang->line('activity_duration_estimates_edit-title')?></h1>
		</div>
		<!-- /.col-lg-12 -->
	</div>
	<!-- /.row -->
	...
	<?php if($this->session->flashdata('success')):?>
		...
		<div class="row">
			<div class="col-lg-12">
					<form action="<?=base_url()?>Activity/updateDurationEstimates/<?php echo $id; ?>" method="post">
