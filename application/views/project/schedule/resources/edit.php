				...
				<div class="row">
					<div class="col-lg-12">
						<div class="panel-body">
							...
							<form action='<?= base_url("schedule/resource/update/$resource_id") ?>' method="post">
									<div class=" col-lg-6 form-group">
										...
										<div>
											<input id="resource_name" name="resource_name" class="form-control input-md" value="<?= $resource_name ?> ">
										</div>
									</div>
                                    ...
                                    <div class=" col-lg-6 form-group">
                                        ...
                                        <div>
                                            <input id="resource_description" name="resource_description" class="form-control input-md" value="<?= $resource_description ?>" >
                                        </div>
                                    </div>
									...
									<div class=" col-lg-3 form-group">
										...
										<div>
											<input id="resource_cost_per_unit" name="resource_cost_per_unit" type="number" min="0.00" max="10000.00" step="0.01" class="form-control input-md" value="<?= $cost_per_unit ?>" >
										</div>
									</div>
									...
									<div class=" col-lg-9 form-group">
										...
										<div>
										<input id="rr_txt_4" type="text" name="resource_type" class="form-control input-md" onkeyup = "limite_textarea(this.value, 'rr_4')" maxlength="2000" oninput="eylem(this, this.value)" required="false" value="<?= $resource_type ?>">
										</div>
									</div>
