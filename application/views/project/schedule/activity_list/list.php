				...
				<div class="row">
					<div class="col-lg-12">
						...
						<div class="panel-body">
							...
							<div class="row">
								<div class="col-lg-12">
									<button class="btn btn-info btn-lg glyphicon-plus" onclick="window.location.href='<?php echo base_url() ?>schedule/activity-list/new/<?php echo $project_id ?>'"> <?= $this->lang->line('activity_list-btn') ?> <?= $this->lang->line('eval-title') ?></button>
								</div>
							</div>
							<br>
