						...
						<div class="panel-body">
							...
							<form method="POST" action="<?php echo base_url('schedule/activity-list/insert/'); ?><?php echo $project_id; ?>">
								...
								<div class=" col-lg-4 form-group">
										...
										<div>
										<input id="al_txt_1" type="text" name="associated_id" class="form-control input-md" onkeyup = "limite_textarea(this.value, 'al_1')" maxlength="2000" oninput="eylem(this, this.value)" required="false">
										</div>
									</div>
									...
									<div class=" col-lg-4 form-group">
										...
										<div>
										<input id="al_txt_3" type="text" name="activity_name" class="form-control input-md" onkeyup = "limite_textarea(this.value, 'al_3')" maxlength="2000" oninput="eylem(this, this.value)" required="false">
										</div>
									</div>
									...
									<div class=" col-lg-6 form-group">
										...
										<div>
										<input id="al_txt_5" type="text" name="wbs_id" class="form-control input-md" onkeyup = "limite_textarea(this.value, 'al_5')" maxlength="2000" oninput="eylem(this, this.value)" required="false">
										</div>
									</div>
									...
									<div class=" col-lg-12 form-group">
										...
										<div>
										<input id="al_txt_6" type="text" name="description" class="form-control input-md" onkeyup = "limite_textarea(this.value, 'al_6')" maxlength="2000" oninput="eylem(this, this.value)" required="false">
										</div>
									</div>
