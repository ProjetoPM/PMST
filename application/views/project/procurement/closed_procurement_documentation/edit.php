						...
						<div class="panel-body">
							...
							<form action="<?= base_url() ?>procurement/closed-procurement-documentation/update/<?php echo $closed_procurement_documentation_id; ?>" method="post">
								...
								<div class="col-lg-5 form-group">
                                    ...
                                    <div>
									<input id="cpd_txt_2" type="text" name="name" class="form-control input-md" onkeyup = "limite_textarea(this.value, 'cpd_2')" maxlength="2000" oninput="eylem(this, this.value)" required="true" value="<?php echo $name; ?>" >
                                ...
                                <div class="col-lg-5 form-group">
                                    ...
                                    <div>
									<input id="cpd_txt_2" type="text" name="supplier_representative" class="form-control input-md" onkeyup = "limite_textarea(this.value, 'cpd_2')" maxlength="2000" oninput="eylem(this, this.value)" required="true" value="<?php echo $supplier_representative; ?>" >
                                    </div>
                                </div>
