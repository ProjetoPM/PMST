<div id="page-wrapper">
	<div class="row" position="absolute">
		<div class="col-lg-12">
			<h1 class="page-header"><?= $this->lang->line('procurement_register') ?></h1>
		</div>
		<!-- /.col-lg-12 -->
		...
		<div class="row">
			<div class="col-lg-12">
				<button class="btn btn-info btn-lg glyphicon-plus" onclick="window.location.href='<?php echo base_url() ?>ProcurementStatementOfWork/addnew/<?php echo $project_id ?>'"> <?= $this->lang->line('btn-new') ?> <?= $this->lang->line('procurement-registration') ?></button>
							...
							<tr dados='<?= json_encode($procurement_statement_of_work); ?>'>
								...
								<td>
									<div class="row center">
										<div class="col-sm-4">
											<form action="<?php echo base_url() ?>ProcurementStatementOfWork/edit/<?php echo $procurement_statement_of_work->id; ?>" method="post">
										...
										<div class="col-sm-4">
											<form action="<?php echo base_url() ?>ProcurementStatementOfWork/delete/<?php echo $procurement_statement_of_work->id; ?>" method="post">
