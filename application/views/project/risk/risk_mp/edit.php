				...
				<div class="row">
					<div class="col-lg-12">
						<div class="panel-body">
							...
							<?php $view_name = "risk management plan";
							...
							?>
								...
								<form method="POST" action="<?php echo base_url('risk/risk-mp/update'); ?>">
									...
									<div class="form-group">
										...
										<a <?= fieldStatus($view_name, $rmp->risk_mp_id, "methodology") ?> data-field="methodology" data-field_name="<?= $this->lang->line('rimp_methodology') ?>" data-item_id="<?= $rmp->risk_mp_id ?>" data-view="<?= $view_name ?>" data-toggle="modal" data-placement="left" data-target="#write-evaluation" data-tt="tooltip"><i class="glyphicon glyphicon-list-alt"></i></a>
										<div>
									...
									<div class="form-group">
										...
										<a <?= fieldStatus($view_name, $rmp->risk_mp_id, "roles_responsibilities") ?> data-field="roles_responsibilities" data-field_name="<?= $this->lang->line('rimp_roles_responsibilities') ?>" data-item_id="<?= $rmp->risk_mp_id ?>" data-view="<?= $view_name ?>" data-toggle="modal" data-placement="left" data-target="#write-evaluation" data-tt="tooltip"><i class="glyphicon glyphicon-list-alt"></i></a>
										<div>
									...
									<div class="form-group">
										...
										<a <?= fieldStatus($view_name, $rmp->risk_mp_id, "probability_impact_matrix") ?> data-field="probability_impact_matrix" data-field_name="<?= $this->lang->line('rimp_probability_impact_matrix') ?>" data-item_id="<?= $rmp->risk_mp_id ?>" data-view="<?= $view_name ?>" data-toggle="modal" data-placement="left" data-target="#write-evaluation" data-tt="tooltip"><i class="glyphicon glyphicon-list-alt"></i></a>
										<div>
									...
									<div class="form-group">
										...
										<a <?= fieldStatus($view_name, $rmp->risk_mp_id, "risks_categories") ?> data-field="risks_categories" data-field_name="<?= $this->lang->line('rimp_risks_categories') ?>" data-item_id="<?= $rmp->risk_mp_id ?>" data-view="<?= $view_name ?>" data-toggle="modal" data-placement="left" data-target="#write-evaluation" data-tt="tooltip"><i class="glyphicon glyphicon-list-alt"></i></a>
										<div>
									...
									<div class="form-group">
										...
										<a <?= fieldStatus($view_name, $rmp->risk_mp_id, "reviewed_tolerances") ?> data-field="reviewed_tolerances" data-field_name="<?= $this->lang->line('rimp_strategy') ?>" data-item_id="<?= $rmp->risk_mp_id ?>" data-view="<?= $view_name ?>" data-toggle="modal" data-placement="left" data-target="#write-evaluation" data-tt="tooltip"><i class="glyphicon glyphicon-list-alt"></i></a>
										<div>
									...
									<div class="form-group">
										...
										<a <?= fieldStatus($view_name, $rmp->risk_mp_id, "traceability") ?> data-field="traceability" data-field_name="<?= $this->lang->line('rimp_tracking') ?>" data-item_id="<?= $rmp->risk_mp_id ?>" data-view="<?= $view_name ?>" data-toggle="modal" data-placement="left" data-target="#write-evaluation" data-tt="tooltip"><i class="glyphicon glyphicon-list-alt"></i></a>
										<div>
									...
									<div class="form-group">
										...
										<a <?= fieldStatus($view_name, $rmp->risk_mp_id, "funding") ?> data-field="funding" data-field_name="<?= $this->lang->line('rimp_funding') ?>" data-item_id="<?= $rmp->risk_mp_id ?>" data-view="<?= $view_name ?>" data-toggle="modal" data-placement="left" data-target="#write-evaluation" data-tt="tooltip"><i class="glyphicon glyphicon-list-alt"></i></a>
										<div>
									...
									<div class="form-group">
										...
										<a <?= fieldStatus($view_name, $rmp->risk_mp_id, "timing") ?> data-field="timing" data-field_name="<?= $this->lang->line('rimp_timing') ?>" data-item_id="<?= $rmp->risk_mp_id ?>" data-view="<?= $view_name ?>" data-toggle="modal" data-placement="left" data-target="#write-evaluation" data-tt="tooltip"><i class="glyphicon glyphicon-list-alt"></i></a>
										<div>
									...
									<div class="form-group">
										...
										<a <?= fieldStatus($view_name, $rmp->risk_mp_id, "stakeholder_risk") ?> data-field="stakeholder_risk" data-field_name="<?= $this->lang->line('rimp_stakeholder') ?>" data-item_id="<?= $rmp->risk_mp_id ?>" data-view="<?= $view_name ?>" data-toggle="modal" data-placement="left" data-target="#write-evaluation" data-tt="tooltip"><i class="glyphicon glyphicon-list-alt"></i></a>
										<div>
									...
									<div class="form-group">
										...
										<a <?= fieldStatus($view_name, $rmp->risk_mp_id, "definitions_risk") ?> data-field="definitions_risk" data-field_name="<?= $this->lang->line('rimp_definitions') ?>" data-item_id="<?= $rmp->risk_mp_id ?>" data-view="<?= $view_name ?>" data-toggle="modal" data-placement="left" data-target="#write-evaluation" data-tt="tooltip"><i class="glyphicon glyphicon-list-alt"></i></a>
										<div>
									...
									<div class="form-group">
										...
										<a <?= fieldStatus($view_name, $rmp->risk_mp_id, "format_report") ?> data-field="format_report" data-field_name="<?= $this->lang->line('rimp_format') ?>" data-item_id="<?= $rmp->risk_mp_id ?>" data-view="<?= $view_name ?>" data-toggle="modal" data-placement="left" data-target="#write-evaluation" data-tt="tooltip"><i class="glyphicon glyphicon-list-alt"></i></a>
										<div>
