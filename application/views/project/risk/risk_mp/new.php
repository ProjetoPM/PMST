						...
						<div class="panel-body">
							...
							<form method="POST" action="<?php echo base_url('risk/risk-mp/insert'); ?>">
								...
								<div class="form-group">
									...
									<a class="btn-sm btn-default" data-toggle="tooltip" data-placement="right" title="<?= $this->lang->line('traceability-tp') ?>"><i class="glyphicon glyphicon-comment"></i></a>
									<div>
										<textarea oninput="eylem(this, this.value)" class="form-control elasticteste" id="funding" name="funding"></textarea>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<a class="btn-sm btn-default" data-toggle="tooltip" data-placement="right" title="<?= $this->lang->line('traceability-tp') ?>"><i class="glyphicon glyphicon-comment"></i></a>
									<div>
										<textarea oninput="eylem(this, this.value)" class="form-control elasticteste" id="timing" name="timing"></textarea>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<a class="btn-sm btn-default" data-toggle="tooltip" data-placement="right" title="<?= $this->lang->line('traceability-tp') ?>"><i class="glyphicon glyphicon-comment"></i></a>
									<div>
										<textarea oninput="eylem(this, this.value)" class="form-control elasticteste" id="stakeholder_risk" name="stakeholder_risk"></textarea>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<a class="btn-sm btn-default" data-toggle="tooltip" data-placement="right" title="<?= $this->lang->line('traceability-tp') ?>"><i class="glyphicon glyphicon-comment"></i></a>
									<div>
										<textarea oninput="eylem(this, this.value)" class="form-control elasticteste" id="definitions_risk" name="definitions_risk"></textarea>
									</div>
								</div>
