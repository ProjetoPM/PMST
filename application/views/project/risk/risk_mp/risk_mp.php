				...
				if($risk_mp != NULL){
					...
					<form action="<?=base_url()?>risk/update/<?php echo $risk_mp[0]->risk_mp_id; ?>" method="post">
						...
						<div class="form-group">
							...
							<div >                     
								<textarea oninput="eylem(this, this.value)" class="form-control elasticteste" id="roles_responsibilities" name="roles_responsabilities"><?php echo $risk_mp[0]->roles_responsibilities; ?></textarea>
							</div>
						</div>
						<div class="form-group">
