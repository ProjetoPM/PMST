...
<div id="page-wrapper">
  <div class="row" position="absolute">
    ...
    <div class="row">
     <div class="col-lg-12">
      <a class="btn btn-workflow btn-lg" href="<?=base_url()?>communication_item/new/<?php echo $project_id; ?>"> Add New Communication</a>
    
     <a class="btn btn-workflow btn-lg" href="<?=base_url()?>communication_item/new_stakeholder/<?php echo $project_id; ?>"> Add New Stakeholder</a>
   </div>
 </div>
<br></br>
