			...
			<div class="row">
				...
				<script type="text/javascript">
					...
					function format (dados) {
						...
						'<tr><td><b><?=$this->lang->line('distribution_reason')?>:</b>' + dados.distribution_reason + '</td></tr>'+
						'<tr><td><b><?=$this->lang->line('allocated_resources')?>:</b>' + dados.allocated_resources + '</td></tr>'+
						'<tr><td><b><?=$this->lang->line('format')?>:</b>' + dados.format + '</td></tr>'+
						'<tr><td><b><?=$this->lang->line('channel')?>: </b>' + dados.channel +'</td> </tr>'+
						'<tr><td><b><?=$this->lang->line('method')?>: </b>' + dados.method +'</td> </tr>'+
						'<tr><td><b><?=$this->lang->line('format')?>: </b>' + dados.format +'</td> </tr>'+
						'<tr><td><b><?=$this->lang->line('frequency')?>: </b>' + dados.frequency +'</td> </tr>'+
						'<tr><td><b><?=$this->lang->line('local')?>: </b>' + dados.local +'</td> </tr>'+
						'<tr><td><b><?=$this->lang->line('status')?>: </b>' + dados.status +'</td> </tr>'+
						'</tr>'+
						'</table>';
					}
				</script>