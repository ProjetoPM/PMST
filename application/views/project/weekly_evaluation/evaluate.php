				...
				<div class="row">
					<div class="col-lg-12">
						<div class="panel-body">
							...
							<form method="POST" action="<?php echo base_url() ?>weekly_evaluation/insert_score/<?php echo $weekly_report['weekly_evaluation_id'] ?>">
								...
								<div class="col-lg-4 form-group">
									<label for="name"><?= $this->lang->line('we_name') ?></label>
									<div>
									<select id="" name="score" class="form-control" required> <option selected value=""> Select </option> <option value="0"; >No OK</option> <option value="1"; >Partially OK</option> <option value="2"; >Ok</option> </select>
									</div>
								</div>
