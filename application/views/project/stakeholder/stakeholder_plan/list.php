...
<script type="text/javascript">
	...
	function format(dados) {
		return '<table cellpadding="5" cellspacing="0" border="0" style="padding-left:50px;">' +
			'<tr>' +
			'<td><b><?= $this->lang->line('average') ?>: </b>' + (dados.average == null ? "" : dados.average) + '</td>' +
			'</tr>' +
			'<tr>' +
			'<td><b><?= $this->lang->line('expected_engagement') ?>: </b>' + (dados.expected_engagement == null ? "" : dados.expected_engagement) + '</td>' +
			'</tr>' +
			'<tr>' +
			'<td><b><?= $this->lang->line('current_engagement') ?>: </b>' + (dados.current_engagement == null ? "" : dados.current_engagement) + '</td>' +
			'</tr>' +
			'<tr>' +
			'<td><b><?= $this->lang->line('strategy') ?>: </b>' + (dados.strategy == null ? "" : dados.strategy) + '</td>' +
			'</tr>' +
			'<tr>' +
			'<td><b><?= $this->lang->line('scope') ?>: </b>' + (dados.scope == null ? "" : dados.scope) + '</td>' +
			'</tr>' +
			'<tr>' +
			'<td><b><?= $this->lang->line('observation') ?>: </b>' + (dados.observation == null ? "" : dados.observation) + '</td>' +
			'</tr>' +
			'</table>';
	}
</script>