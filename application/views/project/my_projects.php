                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td align="left">
                                                ...
                                                <a href="<?= base_url("overleaf-document/" . $pro->project_id) ?>" class="btn btn-default <?php echo $view . $execute; ?>"><em class="fa fa-users"></em><span class="hidden-xs"> Generate Overleaf Document</span></a>
