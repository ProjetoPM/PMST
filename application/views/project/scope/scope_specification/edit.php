              ...
              ?>
                <form method="POST" action="<?php echo base_url('scope/project-scope-statement/update/'); ?>">
                  ...
                  <div class="col-lg-12 form-group">
                    ...
                    <div>
                      <textarea oninput="eylem(this, this.value)" class="form-control elasticteste" id="restrictions" name="restrictions"><?= $scope->restrictions; ?></textarea>
                    </div>
                  </div>
                  ...
                  <div class="col-lg-12 form-group">
                    ...
                    <div>
                      <textarea oninput="eylem(this, this.value)" class="form-control elasticteste" id="restrictions" name="assumptions"><?= $scope->restrictions; ?></textarea>
                    </div>
                  </div>
