            ...
            <div class="panel-body">
              ...
              <form method="POST" action="<?php echo base_url() ?>scope/requirement-documentation/insert">
                ...
                <div class=" col-lg-12 form-group">             
                  ...
                  <div>
                      <textarea onkeyup="limite_textarea(this.value, 'rd_15')" id="rd_txt_15" maxlength="2000" oninput="eylem(this, this.value)" class="form-control elasticteste" name="requirement_situation"></textarea>
                  </div>
                </div>
