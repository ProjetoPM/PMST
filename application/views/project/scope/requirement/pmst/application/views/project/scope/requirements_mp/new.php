						...
						<div class="panel-body">
							...
							<form method="POST" action="<?php echo base_url('scope/requirements-mp/insert/'); ?>">
								...
								<div class=" col-lg-12 form-group">
									...
									<div>
										<textarea oninput="eylem(this, this.value)" class="form-control elasticteste" id="configuration" name="configuration"></textarea>
									</div>
								</div>
								...
								<div class=" col-lg-12 form-group">
									...
									<div>
										<textarea oninput="eylem(this, this.value)" class="form-control elasticteste" id="" name="traceability"></textarea>
									</div>
								</div>
