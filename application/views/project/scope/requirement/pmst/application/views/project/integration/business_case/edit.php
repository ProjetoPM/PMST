              ...
              ?>
                ...
                <form method="POST" action="<?php echo base_url('integration/business-case/update'); ?>">
                  ...
                  <div class=" col-lg-12 form-group">
                    ...
                    <div>
                      <textarea maxlength="2000" oninput="eylem(this, this.value)" class="form-control elasticteste" id="business_deals" name="business_deals"><?php echo $bc->business_deals; ?></textarea>
                    </div>
                  </div>
                  ...
                  <div class=" col-lg-12 form-group">
                    ...
                    <div>
                      <textarea maxlength="2000" oninput="eylem(this, this.value)" class="form-control elasticteste" id="situation_analysis" name="situation_analysis"><?php echo $bc->situation_analysis; ?></textarea>
                    </div>
                  </div>
                  ...
                  <div class=" col-lg-12 form-group">
                    ...
                    <div>
                      <textarea maxlength="2000" oninput="eylem(this, this.value)" class="form-control elasticteste" id="recommendation" name="recommendation"><?php echo $bc->recommendation; ?></textarea>
                    </div>
                  </div>
                  ...
                  <div class=" col-lg-12 form-group">
                    ...
                    <div>
                      <textarea maxlength="2000" oninput="eylem(this, this.value)" class="form-control elasticteste" id="evaluation" name="evaluation"><?php echo $bc->evaluation; ?></textarea>
                    </div>
                  </div>
