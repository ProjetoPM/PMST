												...
												<tr dados='<?= json_encode($change_request); ?>'>
													...
													<td>
														<div class="row center">
															<div class="col-sm-3">
																<form action="<?php echo base_url() ?>integration/change-request/edit/<?php echo $change_request->id; ?>" method="post">
															...
															<div class="col-sm-3">
																<form action="<?php echo base_url() ?>integration/change-request/delete/<?php echo $change_request->id; ?>" method="post">
