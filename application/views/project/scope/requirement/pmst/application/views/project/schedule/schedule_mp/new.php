							...
							<form method="post" action="<?php echo base_url('schedule/schedule-mp/insert/'); ?>">
								...
								<div class="col-lg-12">
									<div class="form-group">
										...
										<textarea oninput="eylem(this, this.value)" class="form-control elasticteste" name="release_iteration"></textarea>
									</div>
								</div>
								...
								<div class="col-lg-6">
									<div class="units_measure">
										...
										<textarea oninput="eylem(this, this.value)" class="form-control elasticteste" name="units_measure"></textarea>
									</div>
								</div>
								...
								<div class="col-lg-6">
									<div class="form-group">
										...
										<textarea oninput="eylem(this, this.value)" class="form-control elasticteste" name="control_thresholds"></textarea>
									</div>
								</div>
