							...
							?>
								...
								<form method="POST" action="<?php echo base_url('integration/project-mp/update'); ?>">
									...
									<div class=" col-lg-12 form-group">
										...
										<div>
											<textarea oninput="eylem(this, this.value)" class="form-control elasticteste" id="" name="requirements_mp"><?php echo $pmp->requirements_mp; ?></textarea>
										</div>
									</div>
									...
									<div class=" col-lg-12 form-group">
										...
										<a class="btn-sm btn-default" data-toggle="tooltip" data-placement="right" title="<?= $this->lang->line('') ?>"><i class="glyphicon glyphicon-comment"></i></a>
										<div>
											<textarea oninput="eylem(this, this.value)" class="form-control elasticteste" id="" name="schedule_mp"><?php echo $pmp->schedule_mp; ?></textarea>
										</div>
									</div>
									...
									<div class=" col-lg-12 form-group">
										...
										<a class="btn-sm btn-default" data-toggle="tooltip" data-placement="right" title="<?= $this->lang->line('') ?>"><i class="glyphicon glyphicon-comment"></i></a>
										<div>
											<textarea oninput="eylem(this, this.value)" class="form-control elasticteste" id="" name="cost_mp"><?php echo $pmp->cost_mp; ?></textarea>
										</div>
									</div>
									...
									<div class=" col-lg-12 form-group">
										...
										<a class="btn-sm btn-default" data-toggle="tooltip" data-placement="right" title="<?= $this->lang->line('') ?>"><i class="glyphicon glyphicon-comment"></i></a>
										<div>
											<textarea oninput="eylem(this, this.value)" class="form-control elasticteste" id="" name="quality_mp"><?php echo $pmp->quality_mp; ?></textarea>
										</div>
									</div>
									...
									<div class=" col-lg-12 form-group">
										...
										<a class="btn-sm btn-default" data-toggle="tooltip" data-placement="right" title="<?= $this->lang->line('') ?>"><i class="glyphicon glyphicon-comment"></i></a>
										<div>
											<textarea oninput="eylem(this, this.value)" class="form-control elasticteste" id="" name="resource_mp"><?php echo $pmp->resource_mp; ?></textarea>
										</div>
									</div>
									...
									<div class=" col-lg-12 form-group">
										...
										<a class="btn-sm btn-default" data-toggle="tooltip" data-placement="right" title="<?= $this->lang->line('') ?>"><i class="glyphicon glyphicon-comment"></i></a>
										<div>
											<textarea oninput="eylem(this, this.value)" class="form-control elasticteste" id="" name="risk_mp"><?php echo $pmp->risk_mp; ?></textarea>
										</div>
									</div>
									...
									<div class=" col-lg-12 form-group">
										...
										<a class="btn-sm btn-default" data-toggle="tooltip" data-placement="right" title="<?= $this->lang->line('') ?>"><i class="glyphicon glyphicon-comment"></i></a>
										<div>
											<textarea oninput="eylem(this, this.value)" class="form-control elasticteste" id="" name="procurement_mp"><?php echo $pmp->procurement_mp; ?></textarea>
										</div>
									</div>
									...
									<div class=" col-lg-12 form-group">
										...
										<a class="btn-sm btn-default" data-toggle="tooltip" data-placement="right" title="<?= $this->lang->line('') ?>"><i class="glyphicon glyphicon-comment"></i></a>
										<div>
											<textarea oninput="eylem(this, this.value)" class="form-control elasticteste" id="" name="stakeholder_mp"><?php echo $pmp->stakeholder_mp; ?></textarea>
										</div>
									</div>
									...
									<div class=" col-lg-12 form-group">
										...
										<a class="btn-sm btn-default" data-toggle="tooltip" data-placement="right" title="<?= $this->lang->line('') ?>"><i class="glyphicon glyphicon-comment"></i></a>
										<div>
											<textarea oninput="eylem(this, this.value)" class="form-control elasticteste" id="" name="scope_baseline"><?php echo $pmp->scope_baseline; ?></textarea>
										</div>
									</div>
									...
									<div class=" col-lg-12 form-group">
										...
										<a class="btn-sm btn-default" data-toggle="tooltip" data-placement="right" title="<?= $this->lang->line('') ?>"><i class="glyphicon glyphicon-comment"></i></a>
										<div>
											<textarea oninput="eylem(this, this.value)" class="form-control elasticteste" id="" name="cost_baseline"><?php echo $pmp->cost_baseline; ?></textarea>
										</div>
									</div>
									...
									<div class=" col-lg-12 form-group">
										...
										<a class="btn-sm btn-default" data-toggle="tooltip" data-placement="right" title="<?= $this->lang->line('') ?>"><i class="glyphicon glyphicon-comment"></i></a>
										<div>
											<textarea oninput="eylem(this, this.value)" class="form-control elasticteste" id="" name="performance"><?php echo $pmp->performance; ?></textarea>
										</div>
									</div>
									...
									<div class="col-lg-12 form-group">
										...
										<div>
											<textarea oninput="eylem(this, this.value)" class="form-control elasticteste" id="project_lifecycle" name="project_lifecycle" required="false"><?php echo $pmp->project_lifecycle; ?></textarea>
										</div>
									</div>
									...
									<div class=" col-lg-12 form-group">
										...
										<a class="btn-sm btn-default" data-toggle="tooltip" data-placement="right" title="<?= $this->lang->line('') ?>"><i class="glyphicon glyphicon-comment"></i></a>
										<div>
											<textarea oninput="eylem(this, this.value)" class="form-control elasticteste" id="" name="development"><?php echo $pmp->development; ?></textarea>
										</div>
									</div>
