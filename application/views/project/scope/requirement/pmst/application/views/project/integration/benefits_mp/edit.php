              ...
              ?>
                ...
                <form method="POST" action="<?php echo base_url('integration/benefits-mp/update'); ?>">
                  ...
                  <div class=" col-lg-12 form-group">
                    ...
                    <div>
                      <textarea maxlength="2000" oninput="eylem(this, this.value)" class="form-control elasticteste" id="target_benefits" name="target_benefits"><?php echo $bc->target_benefits; ?></textarea>
                    </div>
                  </div>
                  ...
                  <div class=" col-lg-12 form-group">
                    ...
                    <div>
                      <textarea maxlength="2000" oninput="eylem(this, this.value)" class="form-control elasticteste" id="strategic_alignment" name="strategic_alignment"><?php echo $bc->strategic_alignment; ?></textarea>
                    </div>
                  </div>
                  ...
                  <div class=" col-lg-12 form-group">
                    ...
                    <div>
                      <textarea maxlength="2000" oninput="eylem(this, this.value)" class="form-control elasticteste" id="schedule_benefit" name="schedule_benefit"><?php echo $bc->schedule_benefit; ?></textarea>
                    </div>
                  </div>
                  ...
                  <div class=" col-lg-12 form-group">
                    ...
                    <div>
                      <textarea maxlength="2000" oninput="eylem(this, this.value)" class="form-control elasticteste" id="benefits_owner" name="benefits_owner"><?php echo $bc->benefits_owner; ?></textarea>
                    </div>
                  </div>
                  ...
                  <div class=" col-lg-12 form-group">
                    ...
                    <div>
                      <textarea maxlength="2000" oninput="eylem(this, this.value)" class="form-control elasticteste" id="indicators" name="indicators"><?php echo $bc->indicators; ?></textarea>
                    </div>
                  </div>
                  ...
                  <div class=" col-lg-12 form-group">
                    ...
                    <div>
                      <textarea maxlength="2000" oninput="eylem(this, this.value)" class="form-control elasticteste" id="premises" name="premises"><?php echo $bc->premises; ?></textarea>
                    </div>
                  </div>
                  ...
                  <div class=" col-lg-12 form-group">
                    ...
                    <div>
                      <textarea maxlength="2000" oninput="eylem(this, this.value)" class="form-control elasticteste" id="risks" name="risks"><?php echo $bc->risks; ?></textarea>
                    </div>
                  </div>
