              ...
              <div class="panel-heading">
                <h3 class="panel-title" style="text-align: center;padding-right: 53px;">
                  <strong><?= $this->lang->line('phases') ?>
                    <!-- <a class="disabled" class="btn-sm btn-default" data-toggle="tooltip" data-placement="right" title="Definir"><i class="glyphicon glyphicon-comment"></i></a> -->
                  </strong>
                </h3>
              </div>
              ...
              <div class="panel-body text-justify" style="background-color:#f5f5f5">
                <div class="panel-body text-center" style="background-color:#f5f5f5">
                          ...
                          <?php } else { ?>
                            ...
                            if ($obj->Project_Management_model->get($project[0]->project_id) == null) { ?>
                              ...
                              <?php } else { ?>
                                ...
                                <a class="disabled" href="<?= base_url("integration/project-performance-report/list/" . $project[0]->project_id) ?>">
                                  <div class=" col-lg-1 midBox integrationColor">
                                    <div class="verticalAlign">
                                      <i class="glyphicon glyphicon-star"></i>
                                ...
                                <a class="disabled" href="<?= base_url("integration/change-request/list/" . $project[0]->project_id) ?>">
                                  <div class=" col-lg-1 midBox integrationColor">
                                    <div class="verticalAlign">
                                      <i class="glyphicon glyphicon-star"></i>
                                ...
                                if ($obj->Project_Closure_model->get($project[0]->project_id) == null) { ?>
                                  <a class="disabled" href="<?= base_url("integration/project-closure/new/" . $project[0]->project_id) ?>">
                                  <?php } else { ?>
                                    <a class="disabled" href="<?= base_url("integration/project-closure/edit/" . $project[0]->project_id) ?>">
                                    <?php   } ?>
                                    <div class=" col-lg-1 midBox integrationColor">
                                      <div class="verticalAlign">
                                        <i class="glyphicon glyphicon-star"></i>
                      ...
                      <div class="col-lg-10 noSpaceSide floatRight">
                        ...
                        if ($obj->Business_case_model->get($project[0]->project_id) == null) { ?>
                          ...
                          <?php } else { ?>
                            ...
                            <a class="disabled" href="<?= base_url("integration/deliverable-status/list/" . $project[0]->project_id) ?>">
                              <div class=" col-lg-1 midBox integrationColor">
                                <div class="verticalAlign">
                                  <i class="glyphicon glyphicon-star"></i>
                            ...
                            <a class="disabled" href="<?= base_url("integration/change-log/list/" . $project[0]->project_id) ?>">
                              <div class=" col-lg-1 midBox integrationColor">
                                <div class="verticalAlign">
                                  <i class="glyphicon glyphicon-star"></i>
                      ...
                      <div class="col-lg-10 noSpaceSide floatRight">
                        ...
                        if ($obj->Benefits_plan_model->get($project[0]->project_id) == null) { ?>
                          ...
                          <?php } else { ?>
                            ...
                            <a class="disabled" href="<?= base_url("integration/work-performance-reports/list/" . $project[0]->project_id) ?>">
                              <div class=" col-lg-1 midBox integrationColor">
                                <div class="verticalAlign">
                                  <i class="glyphicon glyphicon-star"></i>
                            ...
                            <a class="disabled" href="<?= base_url("Maintenance") ?>">
                            ...
                            <a class="disabled" href="<?= base_url("integration/issue-log/list/" . $project[0]->project_id) ?>">
                              <div class=" col-lg-1 midBox integrationColor">
                                <div class="verticalAlign">
                                  <i class="glyphicon glyphicon-star"></i>
                  ...
                  <div class="col-lg-12 wrapper noSpaceSide">
                    <div class="noSpaceSide">
                      ...
                      <div class="col-lg-10 noSpaceSide floatRight">
                        ...
                        <!-- <a class="disabled" href="<?= base_url("Activity/listQuantitative/" . $project[0]->project_id) ?>">
                      <div class=" col-lg-1 midBox timeColor">
                        <div class="verticalAlign">
                          <i class="glyphicon glyphicon-time"></i>
                  ...
                  <div class="col-lg-12 wrapper noSpaceSide">
                    ...
                    <a class="disabled"  href="<?= base_url("Process_plan/new/" . $project[0]->project_id) ?>">
                  <?php } else { ?>
                    <a class="disabled"  href="<?= base_url("Process_plan/edit/" . $project[0]->project_id) ?>">
                  <?php   } ?>
                  ...
                  <div class="col-lg-12 wrapper noSpaceSide">
                    <div class="noSpaceSide">
                      ...
                      <div class="col-lg-10 noSpaceSide floatRight">
                        ...
                        <a class="disabled" href="<?= base_url("resources/team-performance-assessments/list/" . $project[0]->project_id) ?>">
                          <div class=" col-lg-1 midBox hrColor">
                            <div class="verticalAlign">
                              <i class="fa fa-male"></i>
                      ...
                      <div class="col-lg-10 noSpaceSide floatRight">
                        ...
                        if ($obj->Risk_mp_model->get($project[0]->project_id) == null) { ?>
                          ...
                          <?php } else { ?>
                            ...
                            <a href="<?= base_url("risk/risk-checklist/edit/" . $project[0]->project_id) ?>">
                              <div class=" col-lg-1 midBox riskColor">
                                <div class="verticalAlign">
                                  <i class="glyphicon glyphicon-exclamation-sign"></i>
                                  <?= $this->lang->line('risk-checklist') ?>
                                </div>
                              </div>
                            </a>
                  ...
                  <div class="col-md-12 noSpaceSide ">
                    <div class="col-lg-12 wrapper noSpaceSide">
                      <a class="btn btn-warning btn-lg btn-block disabled" href="<?= base_url() ?>notification-board/list/<?php echo $project[0]->project_id; ?>">
