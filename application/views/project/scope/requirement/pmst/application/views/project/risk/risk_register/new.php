						...
						<div class="panel-body">
							...
							<form method="POST" action="<?php echo base_url('risk/risk-register/insert/'); ?><?php echo $id; ?>">
								...
								<div class=" col-lg-6 form-group">
									...
									<div>
										<input id="" name="lessons" type="text" class="form-control input-md">
									</div>
								</div>
								...
								<div class=" col-lg-6 form-group">
									...
									<div>
										<input id="" name="category" type="text" class="form-control input-md">
									</div>
								</div>
								...
								<div class=" col-lg-6 form-group">
									...
									<div>
										<input id="" name="fallback" type="text" class="form-control input-md">
									</div>
								</div>
								...
								<div class=" col-lg-6 form-group">
									...
									<div>
										<input id="" name="contingency_owner" type="text" class="form-control input-md">
									</div>
								</div>
								...
								<div class=" col-lg-6 form-group">
									...
									<div>
										<input id="" name="contingency" type="text" class="form-control input-md">
									</div>
								</div>
								...
								<div class=" col-lg-6 form-group">
									...
									<div>
										<input id="" name="secondary" type="text" class="form-control input-md">
									</div>
								</div>
								...
								<div class=" col-lg-6 form-group">
									...
									<div>
										<input id="" name="residual" type="text" class="form-control input-md">
									</div>
								</div>
								...
								<div class=" col-lg-6 form-group">
									...
									<div>
										<input id="" name="timing" type="text" class="form-control input-md">
									</div>
								</div>
								...
								<div class=" col-lg-6 form-group">
									...
									<div>
										<input id="" name="responses_owner" type="text" class="form-control input-md">
									</div>
								</div>
								...
								<div class=" col-lg-6 form-group">
									...
									<div>
										<input id="" name="responses" type="text" class="form-control input-md">
									</div>
								</div>
								...
								<div class=" col-lg-6 form-group">
									...
									<div>
										<input id="" name="triggers" type="text" class="form-control input-md">
									</div>
								</div>
								...
								<div class=" col-lg-6 form-group">
									...
									<div>
										<input id="" name="causes" type="text" class="form-control input-md">
									</div>
								</div>
								...
								<div class=" col-lg-6 form-group">
									...
									<div>
										<input id="" name="strategy" type="text" class="form-control input-md">
									</div>
								</div>
								...
								<div class=" col-lg-6 form-group">
									...
									<div>
										<input id="" name="effects" type="text" class="form-control input-md">
									</div>
								</div>
								...
								<div class=" col-lg-6 form-group">
									...
									<div>
										<input id="" name="score" type="text" class="form-control input-md">
									</div>
								</div>
								...
								<div class=" col-lg-6 form-group">
									...
									<div>
										<input id="" name="impact" type="text" class="form-control input-md">
									</div>
								</div>
								...
								<div class=" col-lg-6 form-group">
									...
									<div>
										<input id="" name="probability" type="text" class="form-control input-md">
									</div>
								</div>
