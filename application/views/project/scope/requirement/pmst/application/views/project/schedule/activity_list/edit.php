							...
							<form action="<?= base_url() ?>schedule/activity-list/update/<?php echo $id; ?>" method="post">
								...
								<ul class="abas">
									...
									<div class=" col-lg-4 form-group">
										...
										<div>
											<input id="associated_id" name="associated_id" class="form-control input-md" value="<?php echo $associated_id; ?>">
										</div>
									</div>
									...
									<div class=" col-lg-4 form-group">
										...
										<div>
											<input id="" name="activity_name" class="form-control input-md" value="<?php echo $activity_name; ?>">
										</div>
									</div>
									...
									<div class=" col-lg-6 form-group">
										...
										<div>
											<input id="" name="wbs_id" class="form-control input-md" value="<?php echo $wbs_id; ?>">
										</div>
									</div>
									...
									<div class=" col-lg-12 form-group">
										...
										<div>
											<input id="" name="description" type="text" class="form-control input-md" value="<?php echo $description; ?>">
										</div>
									</div>
