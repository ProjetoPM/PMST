						...
						<div class="panel-body">
							...
							<form action="<?= base_url() ?>stakeholder/stakeholder-register/update/<?php echo $stakeholder_id; ?>" method="post">
								...
								<div class=" col-lg-12 form-group">
									...
									<div>
										<textarea maxlength="2000" oninput="eylem(this, this.value)" class="form-control elasticteste" id="essential_requirements" name="essential_requirements"><?php echo $essential_requirements; ?></textarea>
									</div>
								</div>
								...
								<div class=" col-lg-12 form-group">
									...
									<div>
										<textarea maxlength="2000" oninput="eylem(this, this.value)" class="form-control elasticteste" id="main_expectations" name="main_expectations"><?php echo $main_expectations; ?></textarea>
									</div>
								</div>
								...
								<div class=" col-lg-12 form-group">
									...
									<div>
										<textarea maxlength="2000" oninput="eylem(this, this.value)" class="form-control elasticteste" id="interest_phase" name="interest_phase"><?php echo $interest_phase; ?></textarea>
									</div>
								</div>
								...
								<div class=" col-lg-12 form-group">
									...
									<div>
										<textarea maxlength="2000" oninput="eylem(this, this.value)" class="form-control elasticteste" id="observations" name="observations"><?php echo $observations; ?></textarea>
									</div>
								</div>
