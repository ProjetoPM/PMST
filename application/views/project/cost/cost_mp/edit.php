							...
							?>
								...
								<form method="POST" action="<?php echo base_url('cost/cost-mp/update'); ?>">
									...
									<div class="col-lg-12 form-group">
										...
										<a class="btn-sm btn-default" data-toggle="tooltip" data-placement="right" title="<?= $this->lang->line('cosmp_organizational_procedures_tooltip') ?>"><i class="glyphicon glyphicon-comment"></i></a>
										<div>
									...
									<div class=" col-lg-12 form-group">
										...
										<a class="btn-sm btn-default" data-toggle="tooltip" data-placement="right" title="<?= $this->lang->line('cosmp_measurement_rules_tooltip') ?>"><i class="glyphicon glyphicon-comment"></i></a>
