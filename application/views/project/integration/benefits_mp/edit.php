              ...
              ?>
                ...
                <form method="POST" action="<?php echo base_url('integration/benefits-mp/update'); ?>">
                  ...
                  <div class=" col-lg-12 form-group">
                    <label for="target_benefits"><?= $this->lang->line('bp_target_benefits') ?> </label>
                    <span class="bmp_1">2000</span><?= $this->lang->line('character') ?>
                    <a class="btn-sm btn-default" id="bmp_tp_1" data-toggle="tooltip" data-placement="right" title="<?= $this->lang->line('bp_target_benefits_tp') ?>"><i class="glyphicon glyphicon-comment"></i></a>
                    <div>
                  ...
                  <div class=" col-lg-12 form-group">
                    <label for="strategic_alignment"><?= $this->lang->line('bp_strategic_alignment') ?> </label>
                    <span class="bmp_2">2000</span><?= $this->lang->line('character') ?>
                    <a class="btn-sm btn-default" id="bmp_tp_2" data-toggle="tooltip" data-placement="right" title="<?= $this->lang->line('bp_strategic_alignment_tp') ?>"><i class="glyphicon glyphicon-comment"></i></a>
                    <div>
                  ...
                  <div class=" col-lg-12 form-group">
                    <label for="schedule_benefit"><?= $this->lang->line('bp_schedule_benefit') ?> </label>
                    <span class="bmp_3">2000</span><?= $this->lang->line('character') ?>
                    <a class="btn-sm btn-default" id="bmp_tp_3" data-toggle="tooltip" data-placement="right" title="<?= $this->lang->line('bp_schedule_benefit_tp') ?>"><i class="glyphicon glyphicon-comment"></i></a>
                    <div>
                  ...
                  <div class=" col-lg-12 form-group">
                    <label for="benefits_owner"><?= $this->lang->line('bp_benefits_owner') ?> </label>
                    <span class="bmp_4">2000</span><?= $this->lang->line('character') ?>
                    <a class="btn-sm btn-default" id="bmp_tp_4" data-toggle="tooltip" data-placement="right" title="<?= $this->lang->line('bp_benefits_owner_tp') ?>"><i class="glyphicon glyphicon-comment"></i></a>
                    <div>
                  ...
                  <div class=" col-lg-12 form-group">
                    <label for="indicators"><?= $this->lang->line('bp_indicators') ?> </label>
                    <span class="bmp_5">2000</span><?= $this->lang->line('character') ?>
                    <a class="btn-sm btn-default" id="bmp_tp_5" data-toggle="tooltip" data-placement="right" title="<?= $this->lang->line('bp_indicators_tp') ?>"><i class="glyphicon glyphicon-comment"></i></a>
                    <div>
                  ...
                  <div class=" col-lg-12 form-group">
                    <label for="premises"><?= $this->lang->line('bp_premises') ?> </label>
                    <span class="bmp_6">2000</span><?= $this->lang->line('character') ?>
                    <a class="btn-sm btn-default" id="bmp_tp_6" data-toggle="tooltip" data-placement="right" title="<?= $this->lang->line('bp_premises_tp') ?>"><i class="glyphicon glyphicon-comment"></i></a>
                    <div>
                  ...
                  <div class=" col-lg-12 form-group">
                    <label for="risks"><?= $this->lang->line('bp_risks') ?> </label>
                    <span class="bmp_7">2000</span><?= $this->lang->line('character') ?>
                    <a class="btn-sm btn-default" id="bmp_tp_7" data-toggle="tooltip" data-placement="right" title="<?= $this->lang->line('bp_risks_tp') ?>"><i class="glyphicon glyphicon-comment"></i></a>
                    <div>
