<div id="page-wrapper">
	<div class="row">
		<div class="col-lg-12">
			<h1 class="pageheader"> <?=$this->lang->line('delivery_acceptance_term-title')  ?></h1>
		</div>
		<!-- /.col-lg-12 -->
	</div>
	...
	<?php if ($this->session->flashdata('success')): ?>
		...
		<form method="POST" action="<?php echo base_url('DeliveryAcceptanceTerm/update/'); ?><?php echo $id; ?>">
			<input type="hidden" id="project_id" name="project_id" value="<?php echo $project_id; ?>">
								...
								<div class=" col-lg-6 form-group">
									...
									<div>
										<input id="validator_name" type="text" name="validator_name" class="form-control input-md" value="<?php echo $validator_name; ?>">
									</div>
								</div>
								...
								<div class=" col-lg-6 form-group">
									...
									<div>
										<input id="role" type="text" name="role" class="form-control input-md" value="<?php echo $role; ?>">
									</div>
								</div>
