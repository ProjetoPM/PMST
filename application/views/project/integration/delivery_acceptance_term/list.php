	...
	<div class="row" position="absolute">
		...
		<div class="row">
			<div class="col-lg-12">
				...
				<button class="btn btn-info btn-lg glyphicon-plus" onclick="window.location.href='<?php echo base_url() ?>DeliveryAcceptanceTerm/newp/<?php echo $project_id ?>'"> <?= $this->lang->line('btn-new') ?> <?= $this->lang->line('delivery_acceptance_term-title') ?></button>
