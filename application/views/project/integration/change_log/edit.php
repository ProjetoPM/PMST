				...
				Change Log
							...
							<?php extract($change_request); ?>
								...
								<div class="col-lg-6 form-group">
									...
									<input disabled id="requester" name="requester" type="text" class="form-control input-md" required="false" value="<?php echo $requester; ?>">
								</div>
								...
								<div class="col-lg-6 form-group">
									...
									<input disabled  id="number_id" name="number_id" type="number" class="form-control input-md" required="false" value="<?php echo $number_id; ?>">
								</div>
								...
								<div class="col-lg-3 form-group">
									...
									<div class="input-group">
										<input disabled  class="form-control input-md" id="request_date" placeholder="YYYY/MM/DD" type="date" name="request_date" value="<?php echo $request_date; ?>" />
									</div>
								</div>
								...
								<div class="col-lg-3 form-group">
									...
									<div class="input-group">
										<input disabled  class="form-control input-md" id="committee_date" placeholder="YYYY/MM/DD" type="date" name="committee_date" value="<?php echo $committee_date; ?>" />
									</div>
								</div>
								...
								<div class=" col-lg-12 form-group">
									...
									<textarea disabled  oninput="eylem(this, this.value)" class="form-control elasticteste" type="text" id="description" name="description" maxlength="1000"><?php echo $description; ?></textarea>
								</div>
								...
								<div class=" col-lg-6 form-group">
									...
									<textarea disabled  oninput="eylem(this, this.value)" class="form-control elasticteste" type="text" id="impacted_areas" name="impacted_areas" maxlength="1000"><?php echo $impacted_areas; ?></textarea>
								</div>
								...
								<div class=" col-lg-6 form-group">
									...
									<textarea disabled  oninput="eylem(this, this.value)" class="form-control elasticteste" type="text" id="impacted_docs" name="impacted_docs" maxlength="1000"><?php echo $impacted_docs; ?></textarea>
								</div>
								...
								<div class=" col-lg-6 form-group">
									...
									<textarea disabled  oninput="eylem(this, this.value)" class="form-control elasticteste" type="text" id="justification" name="justification" maxlength="1000"><?php echo $justification; ?></textarea>
								</div>
								...
								<div class=" col-lg-6 form-group">
									...
									<textarea  disabled oninput="eylem(this, this.value)" class="form-control elasticteste" type="text" id="comments" name="comments" maxlength="1000"><?php echo $comments; ?></textarea>
								</div>
								...
								<div class=" col-lg-12 form-group">
									...
									<textarea disabled  oninput="eylem(this, this.value)" class="form-control elasticteste" type="text" id="committee_opinion" name="committee_opinion" maxlength="1000"><?php echo $committee_opinion; ?></textarea>
								</div>
								...
								<div class=" col-lg-12 form-group">
									...
									<textarea disabled  oninput="eylem(this, this.value)" class="form-control elasticteste" type="text" id="manager_opinion" name="manager_opinion" maxlength="1000"><?php echo $manager_opinion; ?></textarea>
								</div>
