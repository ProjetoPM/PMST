				...
				<div class="row">
					<div class="col-lg-12">
						<div class="panel-body">
							...
							<form method="POST" action="<?php echo base_url('integration/project-performance-report/insert/'); ?><?php echo $project_id; ?>">
								...
								<div class="col-lg-12 form-group">
									...
									<div>
									<textarea onkeyup="limite_textarea(this.value, 'ppr_1')" id="ppr_txt_1" maxlength="2000" oninput="eylem(this, this.value)" class="form-control elasticteste" name="current_performance_analysis"></textarea>
									</div>
								</div>
								...
								<div class="col-lg-12 form-group">
									...
									<div>
									<textarea onkeyup="limite_textarea(this.value, 'ppr_2')" id="ppr_txt_2" maxlength="2000" oninput="eylem(this, this.value)" class="form-control elasticteste" name="planned_forecasts"></textarea>
									</div>
								</div>
								...
								<div class="col-lg-12 form-group">
									...
									<div>
									<textarea onkeyup="limite_textarea(this.value, 'ppr_3')" id="ppr_txt_3" maxlength="2000" oninput="eylem(this, this.value)" class="form-control elasticteste" name="forecasts_considering_current_performance"></textarea>
									</div>
								</div>
								...
								<div class="col-lg-12 form-group">
									...
									<div>
									<textarea onkeyup="limite_textarea(this.value, 'ppr_4')" id="ppr_txt_4" maxlength="2000" oninput="eylem(this, this.value)" class="form-control elasticteste" name="current_risk_situation"></textarea>
									</div>
								</div>
								...
								<div class="col-lg-12 form-group">
									...
									<div>
									<textarea onkeyup="limite_textarea(this.value, 'ppr_5')" id="ppr_txt_5" maxlength="2000" oninput="eylem(this, this.value)" class="form-control elasticteste" name="current_status_of_issues"></textarea>
									</div>
								</div>
								...
								<div class="col-lg-12 form-group">
									...
									<div>
									<textarea onkeyup="limite_textarea(this.value, 'ppr_6')" id="ppr_txt_6" maxlength="2000" oninput="eylem(this, this.value)" class="form-control elasticteste" name="work_completed_during_the_period"></textarea>
									</div>
								</div>
								...
								<div class="col-lg-12 form-group">
									...
									<div>
									<textarea onkeyup="limite_textarea(this.value, 'ppr_7')" id="ppr_txt_7" maxlength="2000" oninput="eylem(this, this.value)" class="form-control elasticteste" name="work_to_be_completed_in_the_next_period"></textarea>
									</div>
								</div>
								...
								<div class="col-lg-12 form-group">
									...
									<div>
									<textarea onkeyup="limite_textarea(this.value, 'ppr_8')" id="ppr_txt_8" maxlength="2000" oninput="eylem(this, this.value)" class="form-control elasticteste" name="summary_of_changes"></textarea>
									</div>
								</div>
								...
								<div class="col-lg-12 form-group">
									...
									<div>
									<textarea onkeyup="limite_textarea(this.value, 'ppr_9')" id="ppr_txt_9" maxlength="2000" oninput="eylem(this, this.value)" class="form-control elasticteste" name="earned_value_management"></textarea>
									</div>
								</div>
								...
								<div class="col-lg-12 form-group">
									...
									<div>
									<textarea onkeyup="limite_textarea(this.value, 'ppr_10')" id="ppr_txt_10" maxlength="2000" oninput="eylem(this, this.value)" class="form-control elasticteste" name="other_relevant_information"></textarea>
									</div>
								</div>
