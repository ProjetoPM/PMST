						...
						<div class="panel-body">
							...
							<form method="POST" action="<?php echo base_url('integration/project-performance-report/update/'); ?><?php echo $id; ?>">
								...
								<div class="col-lg-12 form-group">
									...
									<a <?= fieldStatus($view_name, $id, "current_performance_analysis") ?> data-field="current_performance_analysis" data-field_name="<?= $this->lang->line('ppr_current_performance_analysis') ?>" data-item_id="<?= $id ?>" data-view="<?= $view_name ?>" data-toggle="modal" data-placement="left" data-target="#write-evaluation" data-tt="tooltip"><i class="glyphicon glyphicon-list-alt"></i></a>
									<div>
								...
								<div class="col-lg-12 form-group">
									...
									<a <?= fieldStatus($view_name, $id, "planned_forecasts") ?> data-field="planned_forecasts" data-field_name="<?= $this->lang->line('ppr_planned_forecasts') ?>" data-item_id="<?= $id ?>" data-view="<?= $view_name ?>" data-toggle="modal" data-placement="left" data-target="#write-evaluation" data-tt="tooltip"><i class="glyphicon glyphicon-list-alt"></i></a>
									<div>
								...
								<div class="col-lg-12 form-group">
									...
									<a <?= fieldStatus($view_name, $id, "forecasts_considering_current_performance") ?> data-field="forecasts_considering_current_performance" data-field_name="<?= $this->lang->line('ppr_forecasts_considering_current_performance') ?>" data-item_id="<?= $id ?>" data-view="<?= $view_name ?>" data-toggle="modal" data-placement="left" data-target="#write-evaluation" data-tt="tooltip"><i class="glyphicon glyphicon-list-alt"></i></a>
									<div>
								...
								<div class="col-lg-12 form-group">
									...
									<a <?= fieldStatus($view_name, $id, "current_risk_situation") ?> data-field="current_risk_situation" data-field_name="<?= $this->lang->line('ppr_current_risk_situation') ?>" data-item_id="<?= $id ?>" data-view="<?= $view_name ?>" data-toggle="modal" data-placement="left" data-target="#write-evaluation" data-tt="tooltip"><i class="glyphicon glyphicon-list-alt"></i></a>
									<div>
								...
								<div class="col-lg-12 form-group">
									...
									<a <?= fieldStatus($view_name, $id, "current_status_of_issues") ?> data-field="current_status_of_issues" data-field_name="<?= $this->lang->line('ppr_current_status_of_issues') ?>" data-item_id="<?= $id ?>" data-view="<?= $view_name ?>" data-toggle="modal" data-placement="left" data-target="#write-evaluation" data-tt="tooltip"><i class="glyphicon glyphicon-list-alt"></i></a>
									<div>
								...
								<div class="col-lg-12 form-group">
									...
									<a <?= fieldStatus($view_name, $id, "work_completed_during_the_period") ?> data-field="work_completed_during_the_period" data-field_name="<?= $this->lang->line('ppr_work_completed_during_the_period') ?>" data-item_id="<?= $id ?>" data-view="<?= $view_name ?>" data-toggle="modal" data-placement="left" data-target="#write-evaluation" data-tt="tooltip"><i class="glyphicon glyphicon-list-alt"></i></a>
									<div>
								...
								<div class="col-lg-12 form-group">
									...
									<a <?= fieldStatus($view_name, $id, "work_to_be_completed_in_the_next_period") ?> data-field="work_to_be_completed_in_the_next_period" data-field_name="<?= $this->lang->line('ppr_work_to_be_completed_in_the_next_period') ?>" data-item_id="<?= $id ?>" data-view="<?= $view_name ?>" data-toggle="modal" data-placement="left" data-target="#write-evaluation" data-tt="tooltip"><i class="glyphicon glyphicon-list-alt"></i></a>
									<div>
								...
								<div class="col-lg-12 form-group">
									...
									<a <?= fieldStatus($view_name, $id, "summary_of_changes") ?> data-field="summary_of_changes" data-field_name="<?= $this->lang->line('ppr_summary_of_changes') ?>" data-item_id="<?= $id ?>" data-view="<?= $view_name ?>" data-toggle="modal" data-placement="left" data-target="#write-evaluation" data-tt="tooltip"><i class="glyphicon glyphicon-list-alt"></i></a>
									<div>
								...
								<div class="col-lg-12 form-group">
									...
									<a <?= fieldStatus($view_name, $id, "earned_value_management") ?> data-field="earned_value_management" data-field_name="<?= $this->lang->line('ppr_earned_value_management') ?>" data-item_id="<?= $id ?>" data-view="<?= $view_name ?>" data-toggle="modal" data-placement="left" data-target="#write-evaluation" data-tt="tooltip"><i class="glyphicon glyphicon-list-alt"></i></a>
									<div>
								...
								<div class="col-lg-12 form-group">
									...
									<a <?= fieldStatus($view_name, $id, "other_relevant_information") ?> data-field="other_relevant_information" data-field_name="<?= $this->lang->line('ppr_other_relevant_information') ?>" data-item_id="<?= $id ?>" data-view="<?= $view_name ?>" data-toggle="modal" data-placement="left" data-target="#write-evaluation" data-tt="tooltip"><i class="glyphicon glyphicon-list-alt"></i></a>
									<div>
