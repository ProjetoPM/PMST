<div id="page-wrapper">
	<div class="row">
		<div class="col-lg-12">
			<h1 class="pageheader"> <?=$this->lang->line('project_performance_report-title')  ?></h1>
		</div>
		<!-- /.col-lg-12 -->
	</div>
	...
	<?php if ($this->session->flashdata('success')): ?>
		...
		<form method="POST" action="<?php echo base_url('ProjectPerformanceReport/update/'); ?><?php echo $id; ?>">
			...
			<div class="col-lg-12 form-group">
				...
				<div >
					<textarea oninput="eylem(this, this.value)" class="form-control elasticteste" id="current_performance_analysis" name="current_performance_analysis" ><?php echo $current_performance_analysis; ?></textarea>
				</div>
			</div>
			...
			<div class="col-lg-12 form-group">
				...
				<div >
					<textarea oninput="eylem(this, this.value)" class="form-control elasticteste" id="planned_forecasts" name="planned_forecasts" ><?php echo $planned_forecasts; ?></textarea>
				</div>
			</div>
			...
			<div class="col-lg-12 form-group">
				...
				<div >
					<textarea oninput="eylem(this, this.value)" class="form-control elasticteste" id="forecasts_considering_current_performance" name="forecasts_considering_current_performance" ><?php echo $forecasts_considering_current_performance; ?></textarea>
				</div>
			</div>
			...
			<div class="col-lg-12 form-group">
				...
				<div >
					<textarea oninput="eylem(this, this.value)" class="form-control elasticteste" id="current_risk_situation" name="current_risk_situation" ><?php echo $current_risk_situation; ?></textarea>
				</div>
			</div>
			...
			<div class="col-lg-12 form-group">
				...
				<div >
					<textarea oninput="eylem(this, this.value)" class="form-control elasticteste" id="current_status_of_issues" name="current_status_of_issues" ><?php echo $current_status_of_issues; ?></textarea>
				</div>
			</div>
			...
			<div class="col-lg-12 form-group">
				...
				<div >
					<textarea oninput="eylem(this, this.value)" class="form-control elasticteste" id="work_completed_during_the_period" name="work_completed_during_the_period" ><?php echo $work_completed_during_the_period; ?></textarea>
				</div>
			</div>
			...
			<div class="col-lg-12 form-group">
				...
				<div >
					<textarea oninput="eylem(this, this.value)" class="form-control elasticteste" id="work_to_be_completed_in_the_next_period" name="work_to_be_completed_in_the_next_period" ><?php echo $work_to_be_completed_in_the_next_period; ?></textarea>
				</div>
			</div>
			...
			<div class="col-lg-12 form-group">
				...
				<div >
					<textarea oninput="eylem(this, this.value)" class="form-control elasticteste" id="summary_of_changes" name="summary_of_changes" ><?php echo $summary_of_changes; ?></textarea>
				</div>
			</div>
			...
			<div class="col-lg-12 form-group">
				...
				<div >
					<textarea oninput="eylem(this, this.value)" class="form-control elasticteste" id="earned_value_management" name="earned_value_management" ><?php echo $earned_value_management; ?></textarea>
				</div>
			</div>
			...
			<div class="col-lg-12 form-group">
				...
				<div >
					<textarea oninput="eylem(this, this.value)" class="form-control elasticteste" id="other_relevant_information" name="other_relevant_information" ><?php echo $other_relevant_information; ?></textarea>
				</div>
			</div>
