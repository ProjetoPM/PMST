		...
		<?php if ($this->session->flashdata('success')): ?>
			...
			<div class="row">
				<div class="col-lg-10">
					...
					<button class="btn btn-info btn-lg glyphicon-plus" onclick="window.location.href='<?php echo base_url() ?>ProjectPerformanceReport/newp/<?php echo $project_id ?>'"> <?=$this->lang->line('btn-new')?> <?=$this->lang->line('project_performance_report-title')?></button>
				...
				<div class="col-lg-12">
								...
								<tr dados='<?= json_encode($report); ?>'>
									...
									<td style="max-width: 20px">
										<div class="row center">
											<div class="col-sm-3">
												<form action="<?php echo base_url() ?>ProjectPerformanceReport/edit/<?php echo $report->id; ?>" method="post">
				 ...
				 <div class="col-sm-12" position= "absolute">
					 <div class="container">
															 ...
															 <?php $view = array(
																 "name" => "project_performance_report",
															 ); ?>
			 ...
			 <link rel="stylesheet" href="//cdn.jsdelivr.net/npm/alertifyjs@1.11.2/build/css/alertify.min.css"/>
				 ...
				 <script type="text/javascript">
					 ...
					 function deletar(idProjeto, id){
						 ...
						 $.post("<?php echo base_url() ?>ProjectPerformanceReport/delete/" + id,
						 {
