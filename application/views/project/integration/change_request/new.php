            ...
            <div class="panel-body">
              ...
              <div class=" col-lg-3 form-group">
                ...
                <div class=" col-lg-6 form-group">
                  ...
                  <div>
										<textarea onkeyup="limite_textarea(this.value, 'cr_4')" id="cr_txt_4" maxlength="2000" oninput="eylem(this, this.value)" class="form-control elasticteste" name="description"></textarea>
									</div>
                </div>
                ...
                <div class=" col-lg-6 form-group">
                  ...
                  <div>
										<textarea onkeyup="limite_textarea(this.value, 'cr_5')" id="cr_txt_5" maxlength="2000" oninput="eylem(this, this.value)" class="form-control elasticteste" name="type"></textarea>
									</div>
                </div>
                ...
                <div class=" col-lg-6 form-group">
                  ...
                  <div>
										<textarea onkeyup="limite_textarea(this.value, 'cr_6')" id="cr_txt_6" maxlength="2000" oninput="eylem(this, this.value)" class="form-control elasticteste" name="impacted_areas"></textarea>
									</div>
                </div>
                ...
                <div class=" col-lg-6 form-group">
                  ...
                  <div>
										<textarea onkeyup="limite_textarea(this.value, 'cr_7')" id="cr_txt_7" maxlength="2000" oninput="eylem(this, this.value)" class="form-control elasticteste" name="impacted_docs"></textarea>
									</div>
                </div>
                ...
                <div class=" col-lg-6 form-group">
                  ...
                  <div>
										<textarea onkeyup="limite_textarea(this.value, 'cr_8')" id="cr_txt_8" maxlength="2000" oninput="eylem(this, this.value)" class="form-control elasticteste" name="justification"></textarea>
									</div>
                </div>
                ...
                <div class=" col-lg-6 form-group">
                  ...
                  <div>
										<textarea onkeyup="limite_textarea(this.value, 'cr_9')" id="cr_txt_9" maxlength="2000" oninput="eylem(this, this.value)" class="form-control elasticteste" name="comments"></textarea>
									</div>
                </div>
                ...
                <div class=" col-lg-6 form-group">
                  ...
                  <div>
										<textarea onkeyup="limite_textarea(this.value, 'cr_10')" id="cr_txt_10" maxlength="2000" oninput="eylem(this, this.value)" class="form-control elasticteste" name="manager_opinion"></textarea>
									</div>
                </div>
                ...
                <div class=" col-lg-6 form-group">
                  ...
                  <div>
										<textarea onkeyup="limite_textarea(this.value, 'cr_11')" id="cr_txt_11" maxlength="2000" oninput="eylem(this, this.value)" class="form-control elasticteste" name="committee_opinion"></textarea>
									</div>
                </div>
