		...
		<?php if ($this->session->flashdata('success')): ?>
			...
			<div class="row">
				<div class="col-lg-10">
					...
					<button class="btn btn-info btn-lg glyphicon-plus" onclick="window.location.href='<?php echo base_url() ?>WorkPerformanceReport/newp/<?php echo $project_id ?>'"> <?=$this->lang->line('btn-new')?> <?=$this->lang->line('project_performance_report-title')?></button>
