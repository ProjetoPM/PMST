<?php
	class Procurement_statement_of_work_model extends CI_Model {
		...
		public function deleteProcurementOfWork($id){
			$this->db->where('procurement_statement_of_work.id', $id);
